...
import { warsaw, card, topButtons, modal, back } from '../warsawconstguide/styles';
...
const Warsawfavouritesguide = () => {
    ...
    const getSightsForCategory = () => {
        if (currentCategory === 'General') {
            return warsawsightsGeneral.filter(sight => 
                warsawFavourite.General.includes(sight.address)
            );
        } else {
            return warsawsightsAdded.filter(sight => 
                warsawFavourite.Added.includes(sight.address)
            );
        }
    };

    const warsawsights = getSightsForCategory();
                            ...
                            warsawsights.length > 0 ? (
                                <View style={{width: '100%', paddingHorizontal: 16}}>
                                        ...
                                        warsawsights.map((sight, i) => (
                                            ...
                                            >
                                                ...
                                                <View style={{ marginBottom: 8 }}>
                                                    ...
                                                    {
                                                        warsawsights === warsawsightsAdded && (
                                                            <TouchableOpacity
                                    ...
                                    <View style={{ width: '100%', marginTop: 120, alignItems: 'center' }}>
                                        ...
                                        <Text style={[warsaw.nothingText, {width: '80%'}]}>
                                            {
                                                currentCategory === 'General' 
                                                    ? "You haven't favorited any general sights yet"
                                                    : "You haven't favorited any added sights yet"
                                            }
                                        </Text>
                                    </View>
                            )
            ...
            >
                ...
                <View style={modal.back}>
                    <View style={modal.container}>
                        ...
                        >
                            <Text style={modal.buttonText}>Edit place</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={modal.button}
                        ...
                        >
                            <Text style={modal.buttonText}>Close</Text>
                        </TouchableOpacity>
...
export default Warsawfavouritesguide;